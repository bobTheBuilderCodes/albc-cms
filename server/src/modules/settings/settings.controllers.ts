...
const defaultBirthdayCongregationSmsTemplate =
...
const settings = await Settings.create({
    ...
    birthdayCongregationSmsTemplate:
      typeof req.body.birthdayCongregationSmsTemplate === "string" &&
      req.body.birthdayCongregationSmsTemplate.trim().length > 0
        ? req.body.birthdayCongregationSmsTemplate.trim()
        : defaultBirthdayCongregationSmsTemplate,
...
export const updateSettings = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (isDefined(req.body.birthdayCongregationSmsTemplate)) {
    updates.birthdayCongregationSmsTemplate = String(req.body.birthdayCongregationSmsTemplate || "").trim();
  }
