  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-br from-blue-600/60 via-blue-700/50 to-blue-800/60" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-8 text-center text-white">
          ...
          <p className="text-lg text-blue-100 max-w-lg text-left leading-relaxed">
